...
def create_interface():
    with gr.Blocks(
        ...
        .result-box { border: 1px solid #ddd; border-radius: 8px; padding: 1rem; margin: 0.5rem 0; }
        .metric-display { font-family: monospace; font-size: 1.1em; font-weight: bold; }
        .status-display { font-size: 1.2em; font-weight: bold; }
        """
    ) as iface:
        ...
        <div class="main-header">
            <h1>🔮 RSM Simulator</h1>
            <h2>Discover How Cultural Symbols Resonate Together</h2>
            <p><strong>Academic Research Demo</strong> | Explore the harmony between Tarot, Astrology, and Korean Saju</p>
            <div style="background: #e8f4fd; padding: 10px; border-radius: 5px; margin: 10px 0; text-align: left; max-width: 600px; margin: 10px auto;">
                <strong>💡 How to use:</strong> Select symbols from different traditions below and watch how they interact!
                Higher harmony scores mean your symbols work well together.
            </div>
        </div>
        """)
